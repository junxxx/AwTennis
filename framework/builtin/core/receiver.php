...
class CoreModuleReceiver extends WeModuleReceiver {
	public function receive() {
		...
		if (($this->message['event'] == 'subscribe' || $this->message['event'] == 'user_get_card') && !empty($_W['account']) && ($_W['account']['level'] == ACCOUNT_SERVICE_VERIFY || $_W['account']['level'] == ACCOUNT_SUBSCRIPTION_VERIFY)) {
