<?php
/**
 * [AwTennis] Copyright (c) 2014 aiwangsports.com
 * AwTennis is NOT a free software, it under the license terms, visited http://www.aiwangsports.com/ for more details.
 */
...
define('APP_URL', 'http://v2.addons.aiwangsports.com/web/');
define('APP_STORE_URL', 'http://v2.addons.aiwangsports.com/web');
define('APP_STORE_API', 'http://v2.addons.aiwangsports.com/api.php');
if($_GET['res']) {
	$res = $_GET['res'];
	$reses = tpl_resources();
...
if($action == 'env') {
	...
	if(version_compare(PHP_VERSION, '5.3.0') == -1) {
		...
		$ret['php']['version']['remark'] = 'PHP版本必须为 5.3.0 以上. <a href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58062">详情</a>';
	}
	...
	if($ret['php']['pdo']['ok']) {
		...
		$ret['php']['pdo']['remark'] = '您的PHP环境不支持PDO, 请开启此扩展. <a target="_blank" href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58074">详情</a>';
	}
	...
	if($ret['php']['curl']['ok']) {
		...
		$ret['php']['curl']['remark'] = '您的PHP环境不支持cURL, 也不支持 allow_url_fopen, 系统无法正常运行. <a target="_blank" href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58086">详情</a>';
	...
	if($ret['php']['ssl']['ok']) {
		...
		$ret['php']['ssl']['remark'] = '没有启用OpenSSL, 将无法访问公众平台的接口, 系统无法正常运行. <a target="_blank" href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58109">详情</a>';
	}
	...
	if($ret['php']['gd']['ok']) {
		...
		$ret['php']['gd']['remark'] = '没有启用GD, 将无法正常上传和压缩图片, 系统无法正常运行. <a target="_blank" href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58110">详情</a>';
	}
	...
	if($ret['php']['dom']['ok']) {
		...
		$ret['php']['dom']['remark'] = '没有启用DOMDocument, 将无法正常安装使用模块, 系统无法正常运行. <a target="_blank" href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58111">详情</a>';
	}
	...
	if($ret['php']['session']['ok'] == 0 || strtolower($ret['php']['session']['ok']) == 'off') {
		...
		$ret['php']['session']['remark'] = '系统session.auto_start开启, 将无法正常注册会员, 系统无法正常运行. <a target="_blank" href="http://bbs.aiwangsports.com/forum.php?mod=redirect&goto=findpost&ptid=3564&pid=58111">详情</a>';
	}
	...
	if($ret['write']['root']['ok']) {
		...
		$ret['write']['root']['remark'] = '本地目录无法写入, 将无法使用自动更新功能, 系统无法正常运行.  <a href="http://bbs.aiwangsports.com/">详情</a>';
	}
	...
	if($ispost) {
		...
		if(empty($error)) {
			...
			if($_POST['type'] == 'remote') {
				...
				if($ins == 'error') {
					die('<script type="text/javascript">alert("版本错误，请确认是否为AwTennis最新版安装文件！");history.back();</script>');
				}
			...
			if(file_exists(IA_ROOT . '/index.php') && is_dir(IA_ROOT . '/web') && file_exists($verfile) && file_exists($dbfile)) {
				...
				die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从AwTennis官网下载完整安装包后重试.");history.back();</script>');
			}
...
function remote_install() {
	...
	$url = 'http://v2.addons.aiwangsports.com/gateway.php';
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - AwTennis - 公众平台自助开源引擎</title>
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装AwTennis系统</a></li>
					<li role="presentation"><a href="http://www.aiwangsports.com">AwTennis官网</a></li>
					<li role="presentation"><a href="http://bbs.aiwangsports.com">访问论坛</a></li>
				</ul>
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.aiwangsports.com">关于AwTennis</a> &nbsp; &nbsp; <a href="http://bbs.aiwangsports.com">AwTennis帮助</a> &nbsp; &nbsp; <a href="http://www.aiwangsports.com">购买授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.aiwangsports.com"><b>AwTennis</b></a> v0.8 &copy; 2014 <a href="http://www.aiwangsports.com">www.aiwangsports.com</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014，AwTennis团队保留所有权利。 </h3>
				<p>
					感谢您选择AwTennis - 微信公众平台自助开源引擎（以下简称WE7，WE7基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于AwTennis系统(We7, MicroEngine. 以下简称AwTennis)任何版本，AwTennis官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改AwTennis源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在AwTennis的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
...
function tpl_install_env($ret = array()) {
	...
	echo <<<EOF
		...
		<div class="alert alert-info">系统要求AwTennis整个安装目录必须可写, 才能使用AwTennis所有功能。</div>
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block">
							...
							在线安装能够直接安装最新版本AwTennis系统, 如果在线安装困难, 请下载离线安装包后使用本地安装. <br/>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“AwTennis - 公众平台自助开源引擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
	<div class="form-group">
		<h5><strong>AwTennis应用商城</strong></h5>
	...
	<div class="alert alert-warning">
		...
		<a target="_blank" class="btn btn-success" href="http://v2.addons.aiwangsports.com" target="_blank">访问应用商城首页</a>
	</div>
EOF;
	tpl_frame();
}
