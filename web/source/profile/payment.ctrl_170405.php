...
if($_W['ispost']) {
    ...
    $wechat = array_elements(array('appid', 'secret', 'switch', 'account', 'signkey', 'partner', 'key', 'version', 'mchid','sub_mch_id', 'apikey', 'version'), $_GPC['wechat']);
    $wechat['switch'] = $wechat['switch'] == 'true';
    $wechat['signkey'] = $wechat['version'] == 2 ? trim($wechat['apikey']) : trim($wechat['signkey']);
    $wechat['apikey'] = trim($wechat['apikey']);
