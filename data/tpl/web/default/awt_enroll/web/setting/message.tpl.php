...
<ul class="nav nav-tabs">
    <li class="active"><a href="javascript:;">消息模板</a></li>
</ul>
            ...
            <div class='panel-body'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <input type="text" name="tp_title" class="form-control" value="<?php  echo $list['title'];?>" placeholder="模版名称，例：替补转正通知" />
                        <?php  } else { ?>
                ...
                <?php  if(is_array($data)) { foreach($data as $list2) { ?>
                    <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('web/setting/message_type', TEMPLATE_INCLUDEPATH)) : (include template('web/setting/message_type', TEMPLATE_INCLUDEPATH));?>
                <?php  } } ?>
                  <?php if( ce('tmessage' ,$list) ) { ?>
...
<script language='javascript'>
    ...
    function addType() {
        ...
        $.ajax({
            url: "<?php  echo $this->createWebUrl('setting/index',array('op'=>'addtype'))?>&kw="+kw,
            cache: false
        }).done(function (html) {
     ...
     <div class='panel panel-default'>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(cv('tmessage.edit|tmessage.view')) { ?><a class='btn btn-default' href="<?php  echo $this->createWebUrl('setting/index', array('op' => 'post', 'id' => $row['id']))?>" title="<?php if(cv('tmessage.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>"><i class='fa fa-edit'></i></a><?php  } ?>
                            <?php if(cv('tmessage.edit')) { ?><a class='btn btn-default'  href="<?php  echo $this->createWebUrl('setting/index', array('op' => 'delete', 'id' => $row['id']))?>" onclick="return confirm('确认删除此模版吗？');return false;" title='删除'><i class='fa fa-remove'></i></a><?php  } ?>
                    </tr>
                    <?php  } } ?>
         ...
         <?php if(cv('tmessage.add')) { ?>
           <div class='panel-footer'>
                            <a class='btn btn-default' href="<?php  echo $this->createWebUrl('setting/index', array('op' => 'post'))?>"><i class="fa fa-plus"></i> 添加新模版</a>
         </div>
         <?php  } ?>
     </div>
       </form>
                ...
                <div class='panel panel-default'>
                    ...
                    <script>
                        ...
                        function send(){
                            ...
                            $.ajax({
                                url: "<?php  echo $this->createWebUrl('setting/index')?>",
                                type:'post',
                                dataType:'json',
