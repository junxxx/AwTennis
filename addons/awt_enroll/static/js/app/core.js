define(['jquery', 'core'], function($, core) {
    ...
    var core = {
        ...
        default_options: {
            baseUrl: '',
            siteUrl: '',
            staticUrl: '../addons/awt_enroll/static/'
        },
        options: {},
    };
      ...
      core.loading =  function() {
          var u = navigator.userAgent, app = navigator.appVersion;
           if ($('#core_loading').length <= 0) {
                $('body').append('<div id="core_loading" style="top:50%;left:50%;margin-left:-35px;margin-top:-30px;position:absolute;width:80px;z-index:999999"><img src="../addons/awt_enroll/static/images/loading.svg" width="80" /></div>')
            }
            else{
                $('#core_loading').show();
            }
